...
public class InsertPerkins extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String insertSql = " INSERT INTO myTablePerkins0225 (id, MYUSER, EMAIL, PHONE, ADDRESS) values (default, ?, ?, ?, ?)";
      ...
      out.println("<a href=/webproject-ex-0214-Perkins/insert_perkins.html>Search Data</a> <br>");
